                    ...
                    {currentResults.repos.map((repo) => (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                          ...
                          >
                            <Star className={`h-4 w-4 ${pinnedRepos.includes(repo.full_name) ? "fill-yellow-500 text-yellow-500" : ""}`} />
                          </Button>
                        </div>
                      </div>
                    ))}
                    ...
                    {currentResults.users.map((user) => (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                          ...
                          >
                            <Star className={`h-4 w-4 ${favoriteUsers.includes(user.login) ? "fill-yellow-500 text-yellow-500" : ""}`} />
                          </Button>
                        </div>
                      </div>
                    ))}
