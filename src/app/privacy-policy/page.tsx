        ...
        <Card>
          ...
          <CardContent className="prose prose-neutral dark:prose-invert max-w-none space-y-6">
            <section>
              ...
              <p>
                GitHubMon only collects the minimum information necessary to
                provide our service:
              </p>
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  <strong>GitHub Profile Information:</strong> Basic public
                  profile data (username, name, email) through GitHub OAuth
                </li>
                <li>
                  <strong>Repository Data:</strong> Public repository
                  information accessible through the GitHub API
                </li>
                <li>
            ...
            <section>
              ...
              <p>
                <strong>Local Storage:</strong> User preferences and session
                data are stored locally in your browser and never transmitted to
                our servers.
              </p>
              <p>
                <strong>Authentication:</strong> We use GitHub&apos;s OAuth
                system for secure authentication. We do not store your GitHub
                passwords or access tokens on our servers.
              </p>
              <p>
                <strong>GitHub API:</strong> All repository and user data is
                fetched directly from GitHub&apos;s public API using your
            ...
            <section>
              ...
              <p>
                ...
                information to third parties. The only data sharing occurs:
              </p>
              <ul className="list-disc pl-6 space-y-2">
            ...
            <section>
              ...
              <p>
                Since we don&apos;t store personal data on our servers, there is
                no data retention period. All personal information exists only
                in your browser&apos;s local storage and your GitHub OAuth
                session.
              </p>
            </section>
