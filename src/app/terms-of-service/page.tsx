        ...
        <Card>
          ...
          <CardContent className="prose prose-neutral dark:prose-invert max-w-none space-y-6">
            ...
            <section>
              ...
              <p>
                GitHubMon is a web application that provides analytics and monitoring tools for GitHub organizations and repositories. 
                The Service uses the GitHub API to fetch and display publicly available data.
              </p>
            </section>
